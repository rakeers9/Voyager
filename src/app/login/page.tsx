      ...
      <main className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-[400px]">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-sm border border-edge bg-surface/60 text-[13px] text-primary hover:bg-surface-hover hover:border-edge-active/40 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            <GoogleIcon />
          ...
          <div className="flex items-center gap-3 my-4">
            <div className="flex-1 h-px bg-edge/70" />
            <span className="text-[10px] uppercase tracking-[0.22em] text-dim font-mono">
              or with email
            </span>
            <div className="flex-1 h-px bg-edge/70" />
          </div>
